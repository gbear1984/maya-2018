...
## Helper Functions #########
def each_frame():
    timeLinestart = timestart###int(cmds.playbackOptions(animationStartTime=True,q=True))
    timeLineEnd = timeend###int(cmds.playbackOptions(animationEndTime=True,q=True))
